...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-line px-6 pt-20">
        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-6 flex items-center gap-2.5">
              {[<XIcon key="x" />, <Linkedin key="li" size={15} strokeWidth={1.75} />, <Instagram key="ig" size={15} strokeWidth={1.75} />].map(
                (icon, i) => (
                  <a
                    key={i}
                    href="#cta"
      ...
      <div
        aria-hidden
        className="pointer-events-none select-none text-center font-display font-semibold leading-none tracking-tight"
        style={{
          fontSize: "19vw",
