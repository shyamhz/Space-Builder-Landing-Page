...
export default function CTA() {
  return (
    <section id="cta" className="relative px-6 py-12">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-line-strong bg-bg-soft px-6 py-24 text-center md:py-32">
        {/* blue aurora */}
        <div
          aria-hidden
        ...
        <div
          ...
          style={{ background: "linear-gradient(to top, var(--bg-soft), transparent)" }}
        />
